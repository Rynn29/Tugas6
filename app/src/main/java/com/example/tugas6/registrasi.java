...
public class registrasi extends AppCompatActivity {
    ...
    public void CheckingEmailAlreadyExistsOrNot(){
        ...
        while (cursor.moveToNext()) {
            if (cursor.isFirst()) {
                cursor.moveToFirst();
                // If Email is already exists then Result variable value set as Email Found.F_Result = "Email Found";
                // Closing cursor.
                cursor.close();
            }
        }
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(registrasi.this,"Email Already Exists", Toast.LENGTH_LONG).show();
        }
        else {
            // If email already dose n't exists then user registrasi details will entered to SQLite database.
    ...
    public void Beck(View view) {
        Intent intent = new
                Intent(registrasi.this,MainActivity.class);
